...
import ai.opencode.client.ui.chat.ChatMessageList
 ...
 *        -Pandroid.testInstrumentationRunnerArguments.class=ai.opencode.client.ReadToolCardIntegrationTest
 */
class ReadToolCardIntegrationTest {
    ...
    fun readToolCallFromServerRendersAsReadCard() {
        ...
        val model = if (modelProvider != null && modelId != null) {
            ai.opencode.client.data.model.Message.ModelInfo(modelProvider, modelId)
        } else null
